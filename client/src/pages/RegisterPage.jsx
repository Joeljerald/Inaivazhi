...
import { BrainCircuit, Lock, Mail, User, Phone, BookOpen, Building, GraduationCap, MapPin, ArrowRight, ShieldCheck } from 'lucide-react';
...
export const RegisterPage = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col justify-center items-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-xl bg-slate-900/90 border border-slate-800 rounded-3xl shadow-2xl backdrop-blur-xl p-8 z-10 my-8">
        <div className="text-center mb-6">
          ...
          <h1 className="text-2xl font-black tracking-tight text-white">Create Student Account</h1>
          <p className="text-xs text-slate-400 font-medium mt-1">
            Join SkillBridge AI to analyze your skill gaps & boost placement readiness
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-slate-950 border border-slate-800 rounded-xl py-2.5 pl-10 pr-4 text-sm text-white focus:outline-none focus:border-indigo-500"
                  required
                />
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            {/* Course */}
            <div>
              <label className="block text-xs font-bold text-slate-300 mb-1">Course Track</label>
              <select
                name="course"
            ...
            {/* Batch */}
            <div>
              <label className="block text-xs font-bold text-slate-300 mb-1">Batch</label>
              <input
                type="text"
                name="batch"
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3 px-4 rounded-xl bg-gradient-to-r from-indigo-600 to-indigo-700 text-white font-bold text-sm shadow-lg shadow-indigo-600/30 hover:from-indigo-500 hover:to-indigo-600 transition-all disabled:opacity-50 mt-4 flex items-center justify-center gap-2"
          >
