        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="p-6 rounded-2xl bg-surface border border-sb-default shadow-sm space-y-4">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-1 bg-amber-50 dark:bg-amber-950/60 px-2.5 py-1 rounded-full border border-amber-200 dark:border-amber-500/40 text-xs font-bold text-amber-700 dark:text-amber-300">
